...
const COLORS = {
  ...
  function render() {
    renderBoard()
    renderMessage()
    // Hide/show UI elements (controls) // play again button, triangle markers
    renderControls()
  }
  
  function renderBoard() {
    board.forEach(function(colArr, colIdx) {     //column array , column index
  ...
  function renderControls() {
    // Ternary expression  <-- the go to when you want 1 of 2 values returned
